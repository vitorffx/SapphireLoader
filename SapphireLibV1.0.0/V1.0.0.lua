...
function SpeedHubLib:Start(GuiConfig)
    ...
    MinimizeButton.Size = UDim2.fromOffset(0, 50, 0, 50)
    MinimizeButton.Position = UDim2.fromScale(0.15, 0, 0.15, 0)
    ...
    UICornerMinimize.CornerRadius = UDim.new(0.25, 0)
