...
function SapphireHubLib:Notify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title = NotifyConfig.Title or "SapphireLibrary"
...
function SapphireHubLib:Start(GuiConfig)
    local GuiConfig = GuiConfig or {}
    GuiConfig.Name = GuiConfig.Name or "SapphireLibrary"
    GuiConfig.Description = GuiConfig.Description or ""
    GuiConfig["Info Color"] = GuiConfig["Info Color"] or Color3.fromRGB(138, 43, 226)
	...
	GuiConfig["Color"] = GuiConfig["Color"] or Color3.fromRGB(155, 89, 182)
	GuiConfig["CloseCallBack"] = GuiConfig["CloseCallBack"] or function() end
    GuiConfig["SaveFolder"] = GuiConfig["SaveFolder"] or false
    local Flags = SapphireHubLib and SapphireHubLib.Flags or {}
    ...
    SapphireGui.Name = "SapphireLibrary"
    ...
    Main.BackgroundColor3 = Color3.fromRGB(28, 15, 45)
    ...
    Main.Position = UDim2.new(0, (SapphireGui.AbsoluteSize.X // 2 - Main.Size.X.Offset // 2), 0, (SapphireGui.AbsoluteSize.Y // 2 - Main.Size.Y.Offset // 2))
    ...
    MinimizeButton.Image = "rbxassetid://72139797777655"
    ...
    MinimizeButton.MouseButton1Click:Connect(SapphireHubLib.ToggleUI)
